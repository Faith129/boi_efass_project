	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
				...
				.authorizeRequests().antMatchers("/", "/error", "/api/all", "/api/auth/**", "/oauth2/**", "/index.html", "/*.js",
						...
						"/authenticate", "/path","/api/v1/download/**","/api/v1/createUser/**","/api/excel/**", "/api/v1/uploadExcel/**","/api/excel/uploadSheet/**", "/api/v1/auth/**", "/v2/api-docs", "/v3/api-docs", "/v3/api-docs/**",
