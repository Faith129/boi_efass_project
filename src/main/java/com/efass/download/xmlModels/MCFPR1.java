...
public class MCFPR1 {
    ...
    public MCFPR1(sheetMcfpr1_Impl sheetMcfpr1_impl, TableImpl table) {
        this.sheetMcfpr1_impl = sheetMcfpr1_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QCFPR1");
        }
    ...
    public Body getBODY() {
        sheetMcfpr1_impl.fetchAllData();
        return new Body(sheetMcfpr1_impl.getSheetMcfpr1XmlList());
    }
    ...
    public void convertToXml(sheetMcfpr1_Impl sheetMcfpr1_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MCFPR1(sheetMcfpr1_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
