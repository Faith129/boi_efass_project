...
@Entity
@Table(name = "QDFIR292_1")
public class sheetQdfir292_1DAO {
    @Id
   // @GeneratedValue(strategy= GenerationType.IDENTITY)
    ...
    public sheetQdfir292_1DAO() {
    }

    public sheetQdfir292_1DAO(Integer id, BigDecimal carrying_value, String derivative_financial_liabilities, BigDecimal notional_amount) {
        this.id = id;
