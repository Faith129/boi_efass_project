...
public class sheet292_1DAO {
	...
	public sheet292_1DAO() {
	}

	public sheet292_1DAO(Integer id, BigDecimal carrying_value, String derivative_financial_liabilities, BigDecimal notional_amount) {
		this.id = id;
