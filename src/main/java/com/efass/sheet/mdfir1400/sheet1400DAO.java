...
public class sheet1400DAO {
    ...
    public sheet1400DAO(Integer id, String branch_code, String branch_name, BigDecimal total_other_assets, BigDecimal total_non_other_performing_assets, BigDecimal watch_list, BigDecimal substandard, BigDecimal doubtful, BigDecimal very_doubtful, BigDecimal lost, BigDecimal dfi_provision, BigDecimal remarks) {
        this.id = id;
