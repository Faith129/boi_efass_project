...
public class sheetQdfir601DAO {
    ...
    public BigDecimal foreign_currency;
    ...
    public sheetQdfir601DAO(Integer id, String customer_name, LocalDate date_approved, BigDecimal foreign_currency, BigDecimal rate_of_exchange, BigDecimal approved_limit, BigDecimal amount_drawn) {
        this.id = id;
    ...
    public BigDecimal getForeign_currency() {
        return foreign_currency;
    }

    public void setForeign_currency(BigDecimal foreign_currency) {
        this.foreign_currency = foreign_currency;
    }
