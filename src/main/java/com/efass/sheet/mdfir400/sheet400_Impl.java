...
//                    result.add(e.getAmount_invested() == null ? "": e.getAmount_invested());
//                    result.add(e.getInvested_certificate_number() == null ? "": e.getInvested_certificate_number());
...
//                        : e.getUpfront_interest_paid());
//                    result.add(e.getAccrued_interest_payable() == null ? ""
//                        : e.getAccrued_interest_payable());
//                    result.add(e.getTimes_rolled_over() == null ? ""
//                        : e.getTimes_rolled_over());
//                    result.add(e.getPrincipal_payable() == null ? ""
//                        : e.getPrincipal_payable());
//                    result.add(e.getImpairment() == null ? ""
//                        : e.getImpairment());
				result.add(e.getGovernment_bonds_federal() == null ? "" : e.getGovernment_bonds_federal());
				result.add(e.getGovernment_bonds_amcon() == null ? "" : e.getGovernment_bonds_amcon());
				result.add(e.getGovernment_bonds_state() == null ? "" : e.getGovernment_bonds_state());
				result.add(e.getGovernment_bonds_local() == null ? "" : e.getGovernment_bonds_local());
				result.add(e.getCorporate_bonds() == null ? "" : e.getCorporate_bonds());
				result.add(e.getTreasury_bills() == null ? "" : e.getTreasury_bills());
				result.add(e.getTreasury_certificates() == null ? "" : e.getTreasury_certificates());
				result.add(e.getCbn_certificates() == null ? "" : e.getCbn_certificates());
				result.add(e.getCertificates_of_deposits_non_negotiable() == null ? "" : e.getCertificates_of_deposits_non_negotiable());
				result.add(e.getBankers_acceptance() == null ? "" : e.getBankers_acceptance());
				result.add(e.getPrincipal_payable() == null ? "" : e.getPrincipal_payable());
				result.add(e.getCommercial_papers() == null ? "" : e.getCommercial_papers());
				result.add(e.getPromissory_notes() == null ? "" : e.getPromissory_notes());
				result.add(e.getAsset_backed_security() == null ? "" : e.getAsset_backed_security());
				result.add(e.getOther_investments() == null ? "" : e.getOther_investments());
...
//
                DataUpdate.setGovernment_bonds_federal(dataM.getGovernment_bonds_federal());
				DataUpdate.setGovernment_bonds_amcon(dataM.getGovernment_bonds_amcon());
				DataUpdate.setGovernment_bonds_state(dataM.getGovernment_bonds_state());
				DataUpdate.setGovernment_bonds_local(dataM.getGovernment_bonds_local());
				DataUpdate.setCorporate_bonds(dataM.getCorporate_bonds());
				DataUpdate.setTreasury_bills(dataM.getTreasury_bills());
				DataUpdate.setTreasury_certificates(dataM.getTreasury_certificates());
                DataUpdate.setCbn_certificates(dataM.getCbn_certificates());
                DataUpdate.setCertificates_of_deposits_non_negotiable(dataM.getCertificates_of_deposits_non_negotiable());
                DataUpdate.setBankers_acceptance(dataM.getBankers_acceptance());
                DataUpdate.setPrincipal_payable(dataM.getPrincipal_payable());
                DataUpdate.setCommercial_papers(dataM.getCommercial_papers());
                DataUpdate.setPromissory_notes(dataM.getPromissory_notes());
                DataUpdate.setAsset_backed_security(dataM.getAsset_backed_security());
                DataUpdate.setOther_investments(dataM.getOther_investments());
