...
@Entity
@Table(name = "QDFIR800")
public class sheetQdfir800DAO  implements Serializable {
    ...
    public sheetQdfir800DAO(){}



    public sheetQdfir800DAO(int id,String code, String description, BigDecimal demand, BigDecimal saving, BigDecimal up_to_90_days,
