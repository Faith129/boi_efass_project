            ...
            if (sheet != null) {
                ...
                for (Row row : sheet) {
                    ...
                    while (cellIterator.hasNext()) {
                        ...
                        switch (cellIndex) {
                            case 0 -> {
                                excelSheetData921.setId((int) cell.getNumericCellValue());
                                System.out.println(excelSheetData921.getId());
                            }
                            case 1 -> {
                                excelSheetData921.setSurname(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getSurname());
                            }

                            case 2 -> {
                                excelSheetData921.setFirst_name(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getFirst_name());
                            }

                            case 3 -> {
                                excelSheetData921.setMiddle_name(cell.getStringCellValue());

                                System.out.println(excelSheetData921.getMiddle_name());
                            }
                            case 4 -> {
                                excelSheetData921.setDesignation(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getDesignation());
                            }

                            case 5 -> {
                                excelSheetData921.setSex(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getSex());
                            }

                            case 6 -> {
                                excelSheetData921.setDate_of_birth(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate());
                                System.out.println(excelSheetData921.getDate_of_birth());
                            }

                            case 7 -> {
                                excelSheetData921.setNationality(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getNationality());
                            }

                            case 8 -> {
                                excelSheetData921.setState_of_origin(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getState_of_origin());
                            }

                            case 9 -> {
                                excelSheetData921.setPassport_number(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getPassport_number());
                            }

                            case 10 -> {
                                excelSheetData921.setNational_id_card_number(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getNational_id_card_number());
                            }

                            case 11 -> {
                                excelSheetData921.setBranch_name(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getNational_id_card_number());
                            }

                            case 12 -> {
                                excelSheetData921.setBranch_code(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getBranch_code());
                            }

                            case 13 -> {
                                excelSheetData921.setState_code(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getState_code());
                            }

                            case 14 -> {
                                excelSheetData921.setDepartment(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getDepartment());
                            }

                            case 15 -> {
                                excelSheetData921.setDate_of_fraud(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate());
                                System.out.println(excelSheetData921.getDate_of_fraud());
                            }

                            case 16 -> {
                                excelSheetData921.setDate_discovered(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate());
                                System.out.println(excelSheetData921.getDate_discovered());
                            }

                            case 17 -> {
                                excelSheetData921.setAmount_involved(BigDecimal.valueOf(cell.getNumericCellValue()));
                                System.out.println(excelSheetData921.getAmount_involved());
                            }

                            case 18 -> {
                                excelSheetData921.setStatus(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getStatus());
                            }

                            case 19 -> {
                                excelSheetData921.setAmount_recovered(BigDecimal.valueOf(cell.getNumericCellValue()));
                                System.out.println(excelSheetData921.getAmount_recovered());
                            }

                            case 20 -> {
                                excelSheetData921.setActual_loss(BigDecimal.valueOf(cell.getNumericCellValue()));
                                System.out.println(excelSheetData921.getActual_loss());
                            }

                            case 21 -> {
                                excelSheetData921.setType(cell.getStringCellValue());
                                System.out.println(excelSheetData921.getType());
                            }

                            case 22 -> {
                                excelSheetData921.setDate(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate()); //optional
                                System.out.println(excelSheetData921.getDate());
                            }
