...
public class sheet921DAO {
    ...
    public sheet921DAO(Integer id, String surname, String first_name, String middle_name, String designation, String sex, LocalDate date_of_birth, String nationality, String state_of_origin, String passport_number, String national_id_card_number, String branch_name, String branch_code, String state_code, String department, LocalDate date_of_fraud, LocalDate date_discovered, BigDecimal amount_involved, String status, BigDecimal amount_recovered, BigDecimal actual_loss, String type, LocalDate date) {
        this.id = id;
