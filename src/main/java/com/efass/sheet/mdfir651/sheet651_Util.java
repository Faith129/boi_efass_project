...
public class sheet651_Util {
	...
	public Boolean writeSpecificList(List<List<Object>> listOfLists, LocalDate Date ,String folderPath)
		...
		for (int i = 0; i < listOfLists.size(); i++) {
			...
			int amountGranted = Integer.parseInt(listAtI.get(4).toString());
			...
			Sheet worksheet = wb.getSheet("651");
			...
			// int cellNum3 =cellNum-3;
			// Access the second cell in second row to update the value
			cell6 = worksheet.getRow(rowNum).getCell(6);
			// Get current cell value value and overwrite the value
			cell6.setCellValue(amountGranted);
			
			Cell cell01 = null;
			cell01 = worksheet.getRow(22).getCell(6);
			String formula= "SUM(G13:G22)";
