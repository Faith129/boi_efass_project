...
public class sheet533DAO {
	...
	public sheet533DAO(Integer id, String code, String description, BigDecimal gross_amount, BigDecimal additions, BigDecimal accumulated_depreciation, BigDecimal impairment) {
		this.id = id;
		this.code = code;
