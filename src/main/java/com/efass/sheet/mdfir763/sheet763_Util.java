...
public class sheet763_Util {
	...
	public Boolean writeSpecificList(List<List<Object>> listOfLists, LocalDate date, String folderPath, String duration) throws EncryptedDocumentException, InvalidFormatException, IOException {
		...
		for (int i = 0; i < listOfLists.size(); i++) {
			...
			String _noOfAccounts =(( listAtI.get(0)== null) ? "0" : listAtI.get(0).toString());
			
			String _amount =(( listAtI.get(1) == null) ? "0" : listAtI.get(1).toString());
			...
			// close the stream
			output_file.close();
			System.out.println("sheet 763 works");
