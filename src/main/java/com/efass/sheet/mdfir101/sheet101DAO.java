...
public class sheet101DAO {
	...
	public sheet101DAO(Integer id, String customer_code, String customer_name, BigDecimal principal_granted, String purpose, LocalDate date_granted, LocalDate due_date, BigDecimal principal_outstanding, BigDecimal interest_rate, BigDecimal upfront_interest, BigDecimal interest_payable, BigDecimal unpaid_principal_interest, String times_rolled_over, String col_value) {
		this.id = id;
