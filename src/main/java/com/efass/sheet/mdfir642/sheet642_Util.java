...
public class sheet642_Util {
	...
	public Boolean writeSpecificList(List<List<Object>> listOfLists, LocalDate Date ,String folderPath)
		...
		for (int i = 0; i < listOfLists.size(); i++) {
			...
			String nameOfLendingInstitution = (String) listAtI.get(0);
			String Country = (String) listAtI.get(1);
			String _datefacilityGranted = (String) listAtI.get(2);
			String _effectiveDate = (String) listAtI.get(3);
			String tenor = (String) listAtI.get(4);	
			int amount = Integer.parseInt(listAtI.get(5).toString());
			
		
			Date datefacilityGranted = new SimpleDateFormat("dd/MM/yyyy").parse(_datefacilityGranted);
			...
			Sheet worksheet = wb.getSheet("642");
			...
			// Get current cell value value and overwrite the value
			cell1.setCellValue(nameOfLendingInstitution);
			...
			// Get current cell value value and overwrite the value
			cell3.setCellValue(datefacilityGranted);
			...
			// Get current cell value value and overwrite the value
			cell4.setCellValue(effectiveDate);
			...
			Cell cell01 = null;
			cell01 = worksheet.getRow(22).getCell(7);
			String formula= "SUM(H13:H22)";
			...
			// close the stream
			output_file.close();
			System.out.println("sheet 642 works");
