...
@Entity
@Table(name = "QDFIR1600")
public class sheetQdfir1600DAO {
    @Id
    ...
    public sheetQdfir1600DAO() {
    }

    public sheetQdfir1600DAO(Integer id, String loan_or_facilities_type, BigDecimal aggregate_amt_principal, BigDecimal aggregate_amt_accrued_interest, BigDecimal aggregate_amt_total_outstanding) {
        this.id = id;
