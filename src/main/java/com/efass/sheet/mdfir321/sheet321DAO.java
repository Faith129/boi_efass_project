...
public class sheet321DAO {
    ...
    public sheet321DAO(Integer id, String bankName, String bankCode, String typeOfPlacements, String account_number, BigDecimal amount, BigDecimal amount2, String tenor, LocalDate effectiveDate, LocalDate maturityDate, BigDecimal interestRate, BigDecimal upfrontInterestReceived, BigDecimal accruedInterestReceivable, BigDecimal times_rolled_over, BigDecimal remarks) {
        this.id = id;
