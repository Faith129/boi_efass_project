...
@Entity
@Table(name = "QDFIR292_2")
public class sheetQdfir292_2DAO {
    @Id
    ...
    public sheetQdfir292_2DAO() {
    }

    public sheetQdfir292_2DAO(Integer id, BigDecimal carrying_value, String derivative_financial_liabilities, BigDecimal notional_amount) {
        this.id = id;
