...
public class sheet311DAO {
    ...
    public sheet311DAO(Integer id, String bankName, String bankCode, String type_of_placements, String account_number, BigDecimal amount, BigDecimal amount_2, String tenor, LocalDate effective_date, LocalDate maturity_date, BigDecimal interest_rate,BigDecimal upfront_interest_received, BigDecimal accrued_interest_receivable, BigDecimal times_rolled_over, String remarks) {
        this.id = id;
