...
@Entity
@Table(name = "MDFIR100")
public class sheet100DAO implements Serializable {
    /**
	 *
	 */
    ...
    public sheet100DAO(Integer id, String code, String description, BigDecimal number_1, BigDecimal value_1, BigDecimal number_2, BigDecimal value_2) {
        super();
        this.id = id;
        this.code = code;
