	...
	public ResponseEntity<?> fetchAllData() {
		...
		if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
			...
			data.forEach((e) -> {
				...
				result.add(e.getRc_or_br_or_sr_no() == null ?  "" : String.valueOf(e.getRc_or_br_or_sr_no()));
