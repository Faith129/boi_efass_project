            ...
            if (sheet != null) {
                ...
                for (Row row : sheet) {
                    ...
                    while (cellIterator.hasNext()) {
                        ...
                        switch (cellIndex) {
                            case 0 -> {
                                excelSheetData920.setId((int) cell.getNumericCellValue());
                                System.out.println(excelSheetData920.getId());
                            }
                            case 1 -> {
                                excelSheetData920.setSurname(cell.getStringCellValue());
                                System.out.println(excelSheetData920.getSurname());
                            }
                            case 2 -> {
                                excelSheetData920.setFirst_name(cell.getStringCellValue());
                                System.out.println(excelSheetData920.getFirst_name());
                            }
                            case 3 -> {
                                excelSheetData920.setMiddle_name(cell.getStringCellValue());
                                System.out.println(excelSheetData920.getMiddle_name());
                            }

                            case 4 -> {
                                excelSheetData920.setDesignation(cell.getStringCellValue());
                                System.out.println(excelSheetData920.getDesignation());
                            }
                            case 5 -> {
                                excelSheetData920.setDate_of_birth(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate());
                                System.out.println(excelSheetData920.getDate_of_birth());
                            }
                            case 6 -> {
                                excelSheetData920.setNational_id_card_number(cell.getStringCellValue());
                                System.out.println(excelSheetData920.getNational_id_card_number());
                            }

                            case 7 -> excelSheetData920.setPermanent_home_address(cell.getStringCellValue());
                            case 8 -> excelSheetData920.setName(cell.getStringCellValue());
                            case 9 -> excelSheetData920.setBranch_code(cell.getStringCellValue());
                            case 10 -> excelSheetData920.setState_code(cell.getStringCellValue());
                            case 11 -> excelSheetData920.setDepartment(cell.getStringCellValue());
                            case 12 -> excelSheetData920.setDate_terminated_or_dismissed(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate());
                            case 13 -> excelSheetData920.setReasons_for_termination(cell.getStringCellValue());
                            case 14 -> excelSheetData920.setDate_reinstated(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate());
                            case 15 -> excelSheetData920.setReason_for_reinstatement(cell.getStringCellValue());
                            case 16 -> excelSheetData920.setOrganization(cell.getStringCellValue());
                            case 17 -> excelSheetData920.setAddress(cell.getStringCellValue());
                            case 18 -> excelSheetData920.setDate_from(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate());
                            case 19 -> excelSheetData920.setDate_to(LocalDateTime.from(cell.getLocalDateTimeCellValue()).toLocalDate());
                            default -> {
                            }
                        }
                        cellIndex++;
