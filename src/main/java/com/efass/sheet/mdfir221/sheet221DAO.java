...
public class sheet221DAO implements Serializable {
	...
	public sheet221DAO(Integer id, String bankCode, String bankName, String account_number, BigDecimal amount, BigDecimal amount_2, BigDecimal remarks, String type_of_balance) {
