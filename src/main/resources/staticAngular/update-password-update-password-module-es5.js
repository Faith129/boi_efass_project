(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["update-password-update-password-module"], {
    ...
    /***/
    function Lhy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CustomValidator = /*#__PURE__*/function () {
        ...
        _createClass(CustomValidator, null, [{
          key: "comparePassword",
          value: function comparePassword(verifyControl) {
            var controlName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'password';
            return function (control) {
              control.setErrors({
                passwordNoMatch: true
              });
              var compare = control.get(controlName).value === control.get(verifyControl).value;
              return compare ? null : {
                passwordNoMatch: true
              };
            };
    ...
    /***/
    function M5AL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_common_input_validator_validator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! src/app/common/input-validator.validator */
      "1Lhy");
      /* harmony import */
      ...
      var src_app_common_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/common/auth.service */
      "KwcT");
      /* harmony import */


      var _user_settings_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      function UpdatePasswordComponent_span_39_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 20);
      ...
      function UpdatePasswordComponent_span_45_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 20);
      ...
      function UpdatePasswordComponent_span_46_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 20);
      ...
      function UpdatePasswordComponent_span_52_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 20);
      ...
      function UpdatePasswordComponent_span_53_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 20);
      ...
      function UpdatePasswordComponent_span_54_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 20);
      ...
      function UpdatePasswordComponent_div_61_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "div", 21);
        }
      }

      function UpdatePasswordComponent_span_62_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var UpdatePasswordComponent = /*#__PURE__*/function () {
        function UpdatePasswordComponent(authService, userSettingsService) {
        ...
        _createClass(UpdatePasswordComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.$user = this.authService.user.subscribe(function (user) {
              _this.username = user === null || user === void 0 ? void 0 : user.username;
            });
          }
        }, {
          key: "changePassword",
          value: function changePassword() {
            ...
            if (this.updatePasswordForm.valid) {
              ...
              this.isLoading = true;
              this.userSettingsService.updatePassword(body).subscribe(function (response) {
                _this2.isLoading = false;

                _this2.updatePasswordForm.reset();
      ...
      UpdatePasswordComponent.ɵfac = function UpdatePasswordComponent_Factory(t) {
        return new (t || UpdatePasswordComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_common_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_user_settings_service__WEBPACK_IMPORTED_MODULE_5__["UserSettingsService"]));
      };
      ...
      UpdatePasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 63,
        vars: 18,
        consts: [[1, "page-header", 2, "padding", "20px 20px"], [1, "container"], [1, "panel", "panel-default"], [1, "panel-heading"], [1, "fa", "fa-external-link-square"], [1, "panel-body"], [1, "col-sm-9"], [2, "color", "gray", "font-size", "15px"], [1, "form-group"], [1, "row"], [1, "col-12", "col-sm-6"], ["role", "form", 1, "form-horizontal", 3, "formGroup", "ngSubmit"], ["for", "form-field-2", 1, "col-sm-2", "control-label"], ["type", "password", "placeholder", "Password", "id", "password", "formControlName", "password", "autocomplete", "new-password", 1, "form-control"], ["class", "error", 4, "ngIf"], ["type", "password", "placeholder", "New Password", "id", "newPassword", "autocomplete", "new-password", "formControlName", "newPassword", 1, "form-control"], ["type", "password", "placeholder", "Confirm New Password", "id", "confirmNewPassword", "formControlName", "confirmNewPassword", "autocomplete", "new-password", 1, "form-control"], ["type", "submit", 1, "btn", "btn-primary", "btn-block", 3, "disabled"], ["class", "loadingSpinner", 4, "ngIf"], [4, "ngIf"], [1, "error"], [1, "loadingSpinner"]],
        template: function UpdatePasswordComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function UpdatePasswordComponent_Template_form_ngSubmit_32_listener() {
        ...
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_6__["TitleCasePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UpdatePasswordComponent, [{
          ...
          return [{
            type: src_app_common_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]
          }, {
            type: _user_settings_service__WEBPACK_IMPORTED_MODULE_5__["UserSettingsService"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    function fV8Y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UpdatePasswordModule", function () {
      ...
      var _update_password_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var routes = [{
        path: '',
        component: _update_password_component__WEBPACK_IMPORTED_MODULE_2__["UpdatePasswordComponent"]
      }];

      var UpdatePasswordModule = function UpdatePasswordModule() {
        _classCallCheck(this, UpdatePasswordModule);
      };

      UpdatePasswordModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: UpdatePasswordModule
      });
      UpdatePasswordModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function UpdatePasswordModule_Factory(t) {
          return new (t || UpdatePasswordModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UpdatePasswordModule, {
          declarations: [_update_password_component__WEBPACK_IMPORTED_MODULE_2__["UpdatePasswordComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]]
        });
      })();
      /*@__PURE__*/
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UpdatePasswordModule, [{
