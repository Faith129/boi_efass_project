(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-settings-user-settings-module"], {
    ...
    /***/
    function XAcJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var routes = [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~create-user-create-user-module~generate-report-generate-report-module~main-main-module~updat~0b1b9fd2"), __webpack_require__.e("common"), __webpack_require__.e("create-user-create-user-module")]).then(__webpack_require__.bind(null,
            /*! ./create-user/create-user.module */
            "WTqH")).then(function (m) {
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~create-user-create-user-module~generate-report-generate-report-module~main-main-module~updat~0b1b9fd2"), __webpack_require__.e("common"), __webpack_require__.e("update-password-update-password-module")]).then(__webpack_require__.bind(null,
            /*! ./update-password/update-password.module */
            "fV8Y")).then(function (m) {
              return m.UpdatePasswordModule;
            });
          }
        }, {
          path: '',
    ...
    /***/
    function zDyl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      UserSettingsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 8,
        vars: 0,
        consts: [["routerLink", "update-password", "routerLinkActive", "active"], ["routerLink", "create-user", "routerLinkActive", "active"]],
