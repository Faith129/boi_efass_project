(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~generate-report-data-generate-report-data-module~main-main-module"], {
    /***/
    "GXRp":
    /*!*****************************************************!*\
    ...
    function OaSA(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatNoDataRow = /*#__PURE__*/function (_angular_cdk_table__W15) {
        ...
        var _super26 = _createSuper(MatNoDataRow);
      ...
      var MatTableDataSource = /*#__PURE__*/function (_angular_cdk_table__W17) {
        ...
        function MatTableDataSource() {
          ...
          _this23._renderData = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"]([]);
          /** Stream that emits when a new filter string is set on the data source. */

          _this23._filter = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"]('');
          ...
          _this23._renderChangesSubscription = rxjs__WEBPACK_IMPORTED_MODULE_5__["Subscription"].EMPTY;
          /**
          ...
          _this23._data = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](initialData);
    ...
    function q7Ft(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatDrawerContent = /*#__PURE__*/function (_angular_cdk_scrollin) {
        ...
        var _super29 = _createSuper(MatDrawerContent);
        ...
        function MatDrawerContent(_changeDetectorRef, _container, elementRef, scrollDispatcher, ngZone) {
          ...
          _this27 = _super29.call(this, elementRef, scrollDispatcher, ngZone);
          _this27._changeDetectorRef = _changeDetectorRef;
          _this27._container = _container;
          return _this27;
        }
      ...
      var MatDrawer = /*#__PURE__*/function () {
        function MatDrawer(_elementRef, _focusTrapFactory, _focusMonitor, _platform, _ngZone, _doc, _container) {
          ...
          this.openedChange.subscribe(function (opened) {
            if (opened) {
              if (_this29._doc) {
                _this29._elementFocusedBeforeDrawerWasOpened = _this29._doc.activeElement;
              }

              _this29._takeFocus();
            } else if (_this29._isFocusWithinDrawer()) {
              _this29._restoreFocus();
            }
          });
          /**
          ...
          this._ngZone.runOutsideAngular(function () {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["fromEvent"])(_this29._elementRef.nativeElement, 'keydown').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["filter"])(function (event) {
              return event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["ESCAPE"] && !_this29.disableClose && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["hasModifierKey"])(event);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(_this29._destroyed)).subscribe(function (event) {
              return _this29._ngZone.run(function () {
                _this29.close();
          ...
          this._animationEnd.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["distinctUntilChanged"])(function (x, y) {
            ...
            if (toState.indexOf('open') === 0 && fromState === 'void' || toState === 'void' && fromState.indexOf('open') === 0) {
              _this29.openedChange.emit(_this29._opened);
            }
          });
        }
        ...
        _createClass(MatDrawer, [{
          ...
          value: function _takeFocus() {
            ...
            this._focusTrap.focusInitialElementWhenReady().then(function (hasMovedFocus) {
              ...
              if (!hasMovedFocus && typeof _this30._elementRef.nativeElement.focus === 'function') {
                _this30._elementRef.nativeElement.focus();
              }
            });
          }
          /**
          ...
          value: function _setOpen(isOpen, restoreFocus) {
            ...
            return new Promise(function (resolve) {
              _this31.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1)).subscribe(function (open) {
      ...
      var MatDrawerContainer = /*#__PURE__*/function () {
        function MatDrawerContainer(_dir, _element, _ngZone, _changeDetectorRef, viewportRuler) {
          ...
          viewportRuler.change().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this._destroyed)).subscribe(function () {
            return _this32.updateContentMargins();
          });
        ...
        _createClass(MatDrawerContainer, [{
          ...
          value: function ngAfterContentInit() {
            ...
            this._allDrawers.changes.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["startWith"])(this._allDrawers), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this._destroyed)).subscribe(function (drawer) {
              _this33._drawers.reset(drawer.filter(function (item) {
                return !item._container || item._container === _this33;
              }));

              _this33._drawers.notifyOnChanges();
            });
            ...
            this._drawers.changes.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["startWith"])(null)).subscribe(function () {
              ...
              _this33._drawers.forEach(function (drawer) {
                _this33._watchDrawerToggle(drawer);

                _this33._watchDrawerPosition(drawer);

                _this33._watchDrawerMode(drawer);
              });

              if (!_this33._drawers.length || _this33._isDrawerOpen(_this33._start) || _this33._isDrawerOpen(_this33._end)) {
            ...
            this._ngZone.runOutsideAngular(function () {
              _this33._doCheckSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["debounceTime"])(10), // Arbitrary debounce time, less than a frame at 60fps
              Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(_this33._destroyed)).subscribe(function () {
          ...
          value: function updateContentMargins() {
            ...
            if (left !== this._contentMargins.left || right !== this._contentMargins.right) {
              ...
              this._ngZone.run(function () {
                return _this34._contentMarginChanges.next(_this34._contentMargins);
              });
            }
          }
        }, {
          ...
          value: function ngDoCheck() {
            ...
            if (this._autosize && this._isPushed()) {
              ...
              this._ngZone.runOutsideAngular(function () {
                return _this35._doCheckSubject.next();
              });
            }
          }
          /**
          ...
          value: function _watchDrawerToggle(drawer) {
            ...
            drawer._animationStarted.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["filter"])(function (event) {
              ...
              if (event.toState !== 'open-instant' && _this36._animationMode !== 'NoopAnimations') {
                _this36._element.nativeElement.classList.add('mat-drawer-transition');
              }
            ...
            if (drawer.mode !== 'side') {
              drawer.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this._drawers.changes)).subscribe(function () {
                return _this36._setContainerClass(drawer.opened);
              });
            }
          }
          /**
          ...
          value: function _watchDrawerPosition(drawer) {
            ...
            drawer.onPositionChanged.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this._drawers.changes)).subscribe(function () {
              _this37._ngZone.onMicrotaskEmpty.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1)).subscribe(function () {
                _this37._validateDrawers();
              });
            });
          }
          ...
          value: function _validateDrawers() {
            ...
            this._drawers.forEach(function (drawer) {
              if (drawer.position == 'end') {
                if (_this39._end != null && (typeof ngDevMode === 'undefined' || ngDevMode)) {
                  throwMatDuplicatedDrawerError('end');
                }

                _this39._end = drawer;
              } else {
                if (_this39._start != null && (typeof ngDevMode === 'undefined' || ngDevMode)) {
                  throwMatDuplicatedDrawerError('start');
                }

                _this39._start = drawer;
              }
            });
          ...
          value: function _closeModalDrawersViaBackdrop() {
            ...
            [this._start, this._end].filter(function (drawer) {
              return drawer && !drawer.disableClose && _this40._canHaveBackdrop(drawer);
      ...
      var MatSidenavContent = /*#__PURE__*/function (_MatDrawerContent) {
        ...
        var _super30 = _createSuper(MatSidenavContent);

        function MatSidenavContent(changeDetectorRef, container, elementRef, scrollDispatcher, ngZone) {
          _classCallCheck(this, MatSidenavContent);

          return _super30.call(this, changeDetectorRef, container, elementRef, scrollDispatcher, ngZone);
        }
      ...
      var MatSidenav = /*#__PURE__*/function (_MatDrawer) {
        ...
        var _super31 = _createSuper(MatSidenav);
        ...
        function MatSidenav() {
          ...
          _this41._fixedInViewport = false;
          _this41._fixedTopGap = 0;
          _this41._fixedBottomGap = 0;
          return _this41;
        }
      ...
      var MatSidenavContainer = /*#__PURE__*/function (_MatDrawerContainer) {
        ...
        var _super32 = _createSuper(MatSidenavContainer);
...
//# sourceMappingURL=default~generate-report-data-generate-report-data-module~main-main-module-es5.js.map