...
GenerateReportDataPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: GenerateReportDataPage, selectors: [["app-assets-and-liability-data"]], viewQuery: function GenerateReportDataPage_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 49, vars: 16, consts: [[1, "page-header"], [1, "row"], [1, "user"], [1, "input-icon"], [2, "color", "#000000"], [1, ""], [1, "nav", "justify-content-end"], [1, "nav-item", "me-2"], ["mat-flat-button", "", 1, "btn_common", 3, "click"], ["matInput", "", "placeholder", "Enter MDFIR300 OR QDFIR300", 3, "keyup"], ["input", ""], ["mat-table", "", 1, "table", 3, "dataSource"], ["matColumnDef", "serialNumber"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "sheetNumber"], ["matColumnDef", "returnCode"], ["matColumnDef", "returnName"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["class", "mat-row", 4, "matNoDataRow"], [4, "ngIf"], [3, "length", "pageSize", "pageSizeOptions"], ["myPaginator", ""], ["mat-header-cell", ""], ["mat-cell", ""], [1, "edits", 3, "click"], ["mat-header-row", ""], ["mat-row", ""], [1, "mat-row"], ["colspan", "4", 1, "mat-cell"], ["colspan", "4", 2, "text-align", "center"], [1, "btn_common", "view", 3, "click"]], template: function GenerateReportDataPage_Template(rf, ctx) { if (rf & 1) {
