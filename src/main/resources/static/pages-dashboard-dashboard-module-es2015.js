...
DashboardPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashboardPage, selectors: [["app-dashboard"]], decls: 27, vars: 4, consts: [["id", "myTopnav", 1, "topnav"], [1, "logo_containerr"], ["routerLink", "/dashboard", 1, ""], ["src", "../../../assets/img/fullBoiLogo.png", 1, "BOI", "logo"], [1, "navbar-brand"], [1, "h4"], [1, "logout", 3, "click"], [1, "sidebar"], ["routerLinkActive", "active", "routerLink", "/dashboard", 3, "routerLinkActiveOptions"], ["routerLinkActive", "active", "routerLink", "generate_report/data/assets"], ["routerLinkActive", "active", "routerLink", "user_settings"], [1, "main"]], template: function DashboardPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardPage_Template_a_click_8_listener() { return ctx.logout(); });
